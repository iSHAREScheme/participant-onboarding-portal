...
const nl = {
  ...
  register: {
    ...
    idCheck: {
      noMethods: "Voor deze onboarding is geen methode voor identiteitsverificatie beschikbaar. Neem contact op met de beheerder van het portaal.",
      vc: {
        chooseFile: "Bestand kiezen",
        lockedNote: "Velden die uit uw Verifiable Credentials zijn ingevuld, zijn vergrendeld — ze komen uit de credential zelf en niet uit dit formulier.",
        intro: "Presenteer Verifiable Credentials (VC's) die u al heeft; wij vullen uw aanvraag daarmee in — voor wat zij aantonen is geen handmatige controle nodig.",
        accepted: "Dit portaal accepteert:",
        tabWallet: "Gebruik uw wallet",
        tabDirect: "Plakken of uploaden",
        start: "VC's presenteren",
        ...
        verifiedTitle: "VC's geverifieerd",
        issuedBy: "Uitgegeven door",
        field: "Ingevuld",
        value: "Waarde",
        stillNeedIdentity: "Deze VC's bevatten geen identiteitsbewijs, dus u heeft nog een eIDAS-certificaat of eHerkenning nodig om af te ronden. De rest is al voor u ingevuld.",
        presentAgain: "Andere VC's presenteren",
        ...
        radioLabel: "met Verifiable Credentials (VC's)",
        radioInfo: "Presenteer Verifiable Credentials die u al heeft, bijvoorbeeld uit een andere dataspace of uw EUDI-wallet. Wij verifiëren ze cryptografisch en vullen uw aanvraag in met wat zij aantonen."
      },
  ...
  settings: {
    ...
    identityMethods: {
      ...
      hint: "Kies hoe aanvragers kunnen aantonen wie zij zijn. Elke onboardingflow kan dit overschrijven, zodat de onboarding van elke dataspace precies de opties biedt die zij accepteert.",
      eidas: "eIDAS-certificaat",
      eherkenning: "eHerkenning",
      vc: "Verifiable Credentials (VC's)",
      vcHint: "Standaard uit: aanvragers kunnen geen Verifiable Credentials presenteren totdat dit is ingeschakeld en hieronder ten minste één uitgever wordt vertrouwd.",
      eherkenningHint: "Vereist een eHerkenning-identiteitsprovider, in te stellen onder Authenticatie. Zolang die ontbreekt, wordt eHerkenning niet aangeboden, ook niet als het is geselecteerd.",
      flowLabel: "Identiteitsverificatie",
    },
    publicOnboarding: {
      vcAutoAccept: "Met VC's geverifieerde aanvragen automatisch accepteren",
